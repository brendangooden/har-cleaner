...
public static class TestDataHelper
{
    ...
    public static HarEntry CreateTestEntry(string url, string method = "GET", int status = 200, 
        ...
        List<HarNameValuePair>? headers = null, List<HarCookie>? cookies = null)
    {
        return new HarEntry
        {
            StartedDateTime = DateTime.UtcNow,
            ...
            Request = new HarRequest
            {
                ...
                Headers = headers ?? new List<HarNameValuePair>(),
                Cookies = cookies ?? new List<HarCookie>(),
    ...
    public static HarEntry CreateEntryWithCookies(string url)
    {
        ...
        return CreateTestEntry(url, "GET", 200, "text/html", 1000, headers, cookies);
    }
