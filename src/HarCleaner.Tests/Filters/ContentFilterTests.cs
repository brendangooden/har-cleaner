...
public class ContentFilterTests
{
	...
	public void ShouldInclude_MaxContentSize_ReplacesLargeContent()
	{
		...
		// Assert
		Assert.True(result);
		Assert.Contains("[CONTENT REMOVED - Size:", entry.Response.Content.Text, StringComparison.OrdinalIgnoreCase);
	}
	...
	public void ShouldInclude_ExcludeContentTypes_RemovesSpecificMimeTypes()
	{
		...
		Assert.Contains("[CONTENT REMOVED - Type:", imageEntry.Response.Content.Text, StringComparison.OrdinalIgnoreCase);
